      ...
      <v-card flat class="body">
        <v-card-title class="header">
          <div class="header-left">
            <div class="header-caption">
              ...
              <p class="help">
                help
                <v-tooltip activator="parent" location="bottom">Fill out all required fields. Put "N/A" if not applicable. </v-tooltip>
              </p>
            </div>
          </div>
          ...
          <div class="header-right">
            <v-btn
              variant="tonal"
              @click="statusType = 'Verify and Review'"
        ...
        <v-card-text class="card-ctr-concept-note">
          ...
          <v-card class="card-concept-note" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="projectTitle.value.value"
              :error-messages="projectTitle.errorMessage.value"
              label="Project Title"
              density="compact"
              required
              rows="1"
            ...
            <v-row>
              <v-col class="card-concept-note">
                <v-textarea
                  v-model="implementingAgency.value.value"
                  :error-messages="implementingAgency.errorMessage.value"
                ...
                />
                <v-textarea
                  v-model="cooperatingAgency.value.value"
                  :error-messages="cooperatingAgency.errorMessage.value"
                ...
                <v-textarea
                  v-model="siteOfImplementation.value.value"
                  :error-messages="siteOfImplementation.errorMessage.value"
              ...
              <v-col class="card-concept-note">
                <v-text-field
                  v-model="projectDuration.value.value"
                  :error-messages="projectDuration.errorMessage.value"
                ...
                <v-text-field
                  v-model="totalProjectCost.value.value"
                  :error-messages="totalProjectCost.errorMessage.value"
                ...
                <v-text-field
                  v-model="fundingSource.value.value"
                  :error-messages="fundingSource.errorMessage.value"
          ...
          <v-card class="card-concept-note2" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="projectDescription.value.value"
              :error-messages="projectDescription.errorMessage.value"
          ...
          <v-card class="card-concept-note2" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="significance.value.value"
              :error-messages="significance.errorMessage.value"
              label="Significance"
              variant="outlined"
              required
              auto-grow
          ...
          <v-card class="card-concept-note2" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="technologyRoadmap.value.value"
              :error-messages="technologyRoadmap.errorMessage.value"
          ...
          <v-card class="card-concept-note2" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="expectedOutputs.value.value"
              :error-messages="expectedOutputs.errorMessage.value"
          ...
          <v-card class="card-concept-note2" variant="flat" color="#fff7ed">
            <v-textarea
              v-model="workPlan.value.value"
              :error-messages="workPlan.errorMessage.value"
              label="Work Plan"
              variant="outlined"
              required
              auto-grow
            ...
            <v-tooltip activator="parent" location="top" width="25%"
              >Detailed plan of activities and timeline for the
              project</v-tooltip
            >
            <v-file-input
              label="Upload images, charts, tables here, if necessary."
