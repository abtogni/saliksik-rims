<template>
  <v-card flat style="padding-top: 0.833rem" class="body" v-for="p in presentations" :key="p._id">
    ...
    <v-card-text>
      <v-card flat class="overview-ctr">
        <v-card variant="outlined" class="card-style">
          <v-expansion-panels>
            <v-expansion-panel title="Panelist Name 1"
              text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, ratione debitis quis est labore voluptatibus! Eaque cupiditate minima">
            </v-expansion-panel>
            <v-expansion-panel title="Panelist Name 2"
              text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, ratione debitis quis est labore voluptatibus! Eaque cupiditate minima">
            </v-expansion-panel>
          </v-expansion-panels>
        </v-card>
