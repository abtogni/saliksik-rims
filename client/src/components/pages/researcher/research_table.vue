<template>
  <div>
    ...
    <v-data-table
      ...
      :search="search"
      density="comfortable"
      style="text-transform: uppercase; font-weight: 600; color: #374151; font-size: 1rem;"
    >
      <template v-slot:item="{ item: research }">
        <tr style="text-transform: capitalize; font-weight: 400; color: #6b7280; font-size: 1rem;">
          <td>
          ...
          <td>
            <v-chip variant="tonal" color="primary"
              >{{ research.research_status }}</v-chip
            >
          </td>
