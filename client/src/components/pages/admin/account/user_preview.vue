    ...
    >
      <v-card-text class="pres-res-body">
        <div class="pres-res-left">
          <v-icon variant="text" style="padding: 1.5rem" size="large" icon="mdi-account-outline"> </v-icon>
          <div class="text">
            <p class="truncate-table">
              {{ `${user.firstName} ${user.lastName}` }}
            </p>
            <v-chip color="default" variant="text" class="p-reg b"
              >Last Active
        ...
        <div class="pres-res-right">
          <v-chip color="primary" class="b">Affiliation</v-chip>
