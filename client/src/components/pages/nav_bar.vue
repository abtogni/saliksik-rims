  ...
  <v-navigation-drawer v-if="showDrawer" expand-on-hover rail>
    ...
    <v-list density="compact" nav>
      ...
      <v-list-item prepend-icon="mdi-file-document-outline" title="Concept Notes" value="concept_notes"
        href="/administrator/concept_note" link>
      ...
      <v-list-item prepend-icon="mdi-note-multiple-outline" title="Research Papers" value="research_progress"
        href="/administrator/research_papers" link>
        <template v-slot:append>
          <v-badge color="info" content="6" inline></v-badge>
        </template>
      </v-list-item>
      ...
      <v-list-item prepend-icon="mdi-account-multiple-outline" title="Accounts" value="accounts"
        href="/administrator/accounts" link>
      </v-list-item>
      ...
      <v-dialog v-model="logoutDialog">
        <v-card class="form_modal_small">
          <v-card-text class="form_content">
            ...
            <div class="form_btn">
              <v-btn variant="flat" @click="logout()" class="button-regular" style="width: 100%">Logout</v-btn>
              <v-btn variant="flat" @click="logoutDialog = false" class="button-outlined"
                style="width: 100%">Cancel</v-btn>
            </div>
          </v-card-text>
        </v-card>
      </v-dialog>
