    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        {:else}
          ...
          {/if}
            ...
            {#if userData}
            <li>
              <a href={`/main/profile/${userData.user._id}`} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">My Profile</a>
            </li>
            <li>
