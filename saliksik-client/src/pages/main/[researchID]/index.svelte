          ...
          <TableBodyRow on:click={() => toggleRow(i)} >
            <TableBodyCell class="">
              <div class="flex justify-start items-center gap-2">
                ...
                <P size="sm" weight="medium" class="line-clamp-1 font-normal">TEST</P>
              </div>
            </TableBodyCell>
            <TableBodyCell class="bg-transparent"><P size="sm" weight="medium" class="line-clamp-1 font-normal">TEST</P></TableBodyCell>
            <TableBodyCell>
            ...
            <TableBodyRow on:dblclick={() => p} class="">
              <TableBodyCell colspan="3" class="">
                <div class="flex flex-wrap justify-center gap-2">
                  ...
                  <Card size="xl" class="gap-2 w-full">
                    <P weight="semibold" size="xl">TEST</P>
