...
<main>
  <Heading tag="h1" class="mb-6 text-xl">Dashboard</Heading>
<Card size="lg" class="w-full">
  <div>
    ...
    <div class="flex justify-between">
      <div class="w-full ">
        <Heading tag="h1" class="text-lg divide-dashed">Recently Updated Researches</Heading>
      </div>
      <div class="w-24 flex flex-wrap justify-around items-stretch ">
        <BookOutline />
        <BookOutline />
        <BookOutline />
      </div>
    ...
    <!--look for icons-->
    Slim down research list
    Expand research list
    Refresh research list
<Table class="table-fixed">
  <TableHead>
    <TableHeadCell class="w-3/4">
      Research Title
    </TableHeadCell>
    <TableHeadCell>
    </TableHeadCell>
  ...
  <TableBody>
    <TableBodyRow>
      ...
      <TableBodyCell class="flex flex-wrap justify-evenly items-stretch">
        <BookOutline />
        <BookOutline />
        <BookOutline />
        <BookOutline />
...
<Card padding="none" class="border-none shadow-none">
<div>
  Research Title
  <!--look for icons-->
  Research status
...
<div>
  <!--look for icons-->
  Copy research link to clipboard
  Edit article
  View article
  Delete article
  ...
  <Heading tag="h1" class="mb-6 text-xl">Create Research Proposal</Heading>
