<script lang="ts">
  ...
  import { Heading, TabItem, TableBody, TableBodyCell, TableBodyRow, Table, TableHead, TableHeadCell, Tabs, TableSearch, Avatar, Popover, Card, Button, Modal, Accordion, AccordionItem, Listgroup, ListgroupItem } from "flowbite-svelte";
...
<main class="h-full w-screen bg-white">
  ...
  <!--tabs and table-->
  <Tabs style="underline" class="grid grid-flow-col justify-stretch">
